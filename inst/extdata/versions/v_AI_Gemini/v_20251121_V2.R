###############################################################################
#  Pan-cancer / TME marker list — source: Gemini 20251121 V2
...
cat("[Gemini 20251121 V2] markers_df:", nrow(markers_df), "rows /", length(unique(markers_df$Level4_Abb)), "cell types\n")
