###############################################################################
#  Pan-cancer / TME marker list — source: DeepResearch v_20260106M
...
cat("[DeepResearch v_20260106M] markers_df:", nrow(markers_df), "rows /", length(unique(markers_df$Level4_Abb)), "cell types\n")
