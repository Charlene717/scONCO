###############################################################################
#  Pan-cancer / TME marker list — source: DeepResearch v_20251209
...
cat("[DeepResearch v_20251209] markers_df:", nrow(markers_df), "rows /", length(unique(markers_df$Level4_Abb)), "cell types\n")
