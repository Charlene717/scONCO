###############################################################################
#  Pan-cancer / TME marker list — source: DeepResearch early 20251007
#  scONCO alternative AI-source curation (compact, valid reconstruction).
#  Defines markers_df (gene|Level1|Level2|Level3|Level4_Abb).
###############################################################################
...
cat("[DeepResearch early 20251007] markers_df:", nrow(markers_df), "rows /", length(unique(markers_df$Level4_Abb)), "cell types\n")
